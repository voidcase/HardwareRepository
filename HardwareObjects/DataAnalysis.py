...
class DataAnalysis(AbstractDataAnalysis.AbstractDataAnalysis, HardwareObject):
    ...
    def characterise(self, edna_input, use_thread=False):
        if use_thread:
             self._characerise_in_thread(enda_input)
	else:
             self._characterise_in_coroutine(edna_input)

    def _characterise_in_thread(self, edna_input):
    ...
    def _characterise_in_coroutine(self, edna_input):
